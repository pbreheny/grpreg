...
* Breheny P and Huang J (2015). Group descent algorithms for nonconvex penalized linear and logistic regression models with grouped predictors. *Statistics and Computing*, **25**: 173-187. [[pdf](https://pbreheny.org/web/assets/group-computing.pdf)].
...
* Breheny P and Huang J (2009). Penalized methods for bi-level variable selection. *Statistics and Its Interface*, **2**: 369-380. [[pdf](https://pbreheny.org/web/assets/Breheny2009.pdf)]
* Huang J, Breheny P and Ma S (2012). A selective review of group selection in high-dimensional models. *Statistical Science*, **27**: 481-499. [[pdf](https://pbreheny.org/web/assets/Huang2012.pdf)]
