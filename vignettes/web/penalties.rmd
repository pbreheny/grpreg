...
* Breheny P and Huang J (2015). Group descent algorithms for nonconvex penalized linear and logistic regression models with grouped predictors. *Statistics and Computing*, **25**: 173-187. [[pdf](http://myweb.uiowa.edu/pbreheny/pdf/group-computing.pdf)].
...
* Breheny P (2015). The group exponential lasso for bi-level variable selection. *Biometrics*, **71**: 731-740. [[pdf](http://onlinelibrary.wiley.com/doi/10.1111/biom.12300/pdf)].
...
* Breheny P and Huang J (2009). Penalized methods for bi-level variable selection. *Statistics and Its Interface*, **2**: 369-380. [[pdf](http://myweb.uiowa.edu/pbreheny/pdf/Breheny2009.pdf)]
* Huang J, Breheny P and Ma S (2012). A selective review of group selection in high-dimensional models. *Statistical Science*, **27**: 481-499. [[pdf](http://myweb.uiowa.edu/pbreheny/pdf/Huang2012.pdf)]
...
* Breheny P and Huang J (2009). Penalized methods for bi-level variable selection. *Statistics and Its Interface*, **2**: 369-380. [[pdf](\href{http://myweb.uiowa.edu/pbreheny/publications/Breheny2009.pdf)]
