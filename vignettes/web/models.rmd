...
L(\bb|\X,\y) = \frac{1}{2} \norm{\y-\X\bb}_2^2;
$$
the factor of 1/2 is so that this loss is equivalent to deviance if the outcome $\y$ follows a normal distribution with constant variance and mean given by $\X\bb$.
