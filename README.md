...
- [Breheny, P. and Huang, J. (2009) Penalized methods for bi-level variable selection. _Statistics and its interface_, **2**: 369-380.](https://pbreheny.org/web/assets/Breheny2009.pdf)
- [Breheny, P. and Huang, J. (2015) Group descent algorithms for nonconvex penalized linear and logistic regression models with grouped predictors. _Statistics and Computing_, **25**: 173-187.](https://dx.doi.org/10.1007/s11222-013-9424-2)
