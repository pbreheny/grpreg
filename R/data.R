...
#'
#' This version of the data set has been deprecated and will not be supported in future versions.
#' Please use [Birthwt] instead.
#'
...
#'   }
#'   \item{lwt1,lwt2,lwt3}{
#'     Orthogonal polynomials of first, second, and third degree representing mother's weight in
...
#'   \item{ptl1,ptl2m}{
#'     Indicator functions for one or for two or more previous premature labors, respectively. No
#'     previous premature labors is the reference category.
#'   }
#'   \item{ht}{History of hypertension}
#'   \item{ui}{Presence of uterine irritability}
#'   \item{ftv1,ftv2,ftv3m}{
#'     Indicator functions for one, for two, or for three or more physician visits during the first
...
#' Risk Factors Associated with Low Infant Birth Weight
#'
#' The `Birthwt` data contains 189 observations, 16 predictors, and an outcome, birthweight,
#' available both as a continuous measure and a binary indicator for low birth weight.The data were
#' collected at Baystate Medical Center, Springfield, Mass during 1986. This data frame is a
...
#'
#' @seealso `grpsurv()`
#' @references Kalbfleisch D and Prentice RL (1980), *The Statistical Analysis of Failure Time
#'   Data*. Wiley, New York.
"Lung"
