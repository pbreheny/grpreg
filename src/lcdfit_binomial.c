...
// KKT check
int gLCD_bCheck(double *b, const char *penalty, double *x, double *r, double *eta, int g, int *K1, int n, int l, int p, double lam1, double lam2, double gamma, double tau, double *a,  int *e) {
