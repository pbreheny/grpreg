...
SEXP cleanupG_ssr_no_active(double *a, double *r, int *e2, int *K, double *xTr, 
...
SEXP gdfit_gaussian_ssr_no_active(SEXP X_, SEXP y_, SEXP penalty_, SEXP K1_, SEXP K0_, 
  ...
  for (int l=lstart; l<L; l++) {
    ...
    if (l != 0) {
      ...
      if (ng > gmax | nv > dfmax) {
        ...
        res = cleanupG_ssr_no_active(a, r, e2, K, xTr, beta, iter, df, loss, rejections);
        return(res);
      }
    }
