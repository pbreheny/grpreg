...
void gLCD_cox(double *b, const char *penalty, double *x, double *r, double *eta, int g, int *K1, int n, int l, int p, double lam1, double lam2, double gamma, double tau, SEXP df, double *a, double delta, int *e) {
...
// KKT check
int gLCD_cCheck(double *b, const char *penalty, double *x, double *r, double *eta, int g, int *K1, int n, int l, int p, double lam1, double lam2, double gamma, double tau, double *a,  int *e) {
...
SEXP lcdfit_cox(SEXP X_, SEXP y_, SEXP penalty_, SEXP K1_, SEXP K0_, SEXP lambda, SEXP alpha_, SEXP eps_, SEXP delta_, SEXP gamma_, SEXP tau_, SEXP max_iter_, SEXP group_multiplier, SEXP dfmax_, SEXP gmax_, SEXP warn_, SEXP user_) {
  ...
  for (int l=lstart; l<L; l++) {
	...
	for (int g=0; g<J; g++) {
	  ...
	  gLCD_cox(b, penalty, X, r, eta, g, K1, n, l, p, l1, l2, gamma, tau, df, a, delta, e);
	}
	...
	l1 = lam[l] * m[g] * alpha;
	l2 = lam[l] * m[g] * (1-alpha);
	violations += gLCD_cCheck(b, penalty, X, r, eta, g, K1, n, l, p, l1, l2, gamma, tau, a, e);
      }
